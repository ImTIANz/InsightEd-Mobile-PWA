...
const ShiftingModalities = () => {
    ...
    // --- VISIBILITY HELPERS (Same as Enrolment) ---
    ...
    const confirmSave = async () => {
        ...
        // If a level is hidden (not offered), we clear its data to keep the DB clean.
        const cleanShifts = { ...shifts };
        const cleanModes = { ...modes };

        if (!showElem()) {
            ["kinder", "g1", "g2", "g3", "g4", "g5", "g6"].forEach(l => {
                cleanShifts[`shift_${l}`] = "";
                cleanModes[`mode_${l}`] = "";
            });
        }
        if (!showJHS()) {
            ["g7", "g8", "g9", "g10"].forEach(l => {
                cleanShifts[`shift_${l}`] = "";
                cleanModes[`mode_${l}`] = "";
            });
        }
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Update local state to match the cleaned data
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="font-bold text-gray-800 flex items-center gap-2">
                            <span className="text-xl">📊</span> Per Grade Strategy
                        </h2>
